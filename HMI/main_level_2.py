...
Description: This script launches a HMI where to decide whether to replicate an own construction (3D) or to build some backup constructions.
...
from take_photos import Captura_1, Captura_2, come_from_zone_1, come_from_zone_2, go_zone_1, go_zone_2
